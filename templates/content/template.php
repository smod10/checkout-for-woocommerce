...
<!--                                <div class="cfw-sg-container cfw-input-wrap-row">-->
<!--                                    <div class="cfw-column-4">-->
<!--                                        <div class="cfw-input-wrap cfw-select-input">-->
<!--                                            <label class="cfw-input-label" for="cfw-country-select">Country</label>-->
<!--                                            <select title="Billing Country" id="cfw-billing-country" name="cfw-billing-country" autocomplete="billing country" class="required garlic-auto-save">-->
<!--                                                <option value=""></option><option value="AR">Argentina</option><option value="AU">Australia</option><option value="AT">Austria</option><option value="BS">Bahamas</option><option value="BE">Belgium</option><option value="BR">Brazil</option><option value="CA">Canada</option><option value="CL">Chile</option><option value="CN">China</option><option value="CO">Colombia</option><option value="CR">Costa Rica</option><option value="HR">Croatia</option><option value="CY">Cyprus</option><option value="CZ">Czech Republic</option><option value="DK">Denmark</option><option value="EC">Ecuador</option><option value="EE">Estonia</option><option value="FI">Finland</option><option value="FR">France</option><option value="DE">Germany</option><option value="GR">Greece</option><option value="GP">Guadeloupe</option><option value="HK">Hong Kong</option><option value="HU">Hungary</option><option value="IS">Iceland</option><option value="IN">India</option><option value="ID">Indonesia</option><option value="IE">Ireland</option><option value="IL">Israel</option><option value="IT">Italy</option><option value="JM">Jamaica</option><option value="JP">Japan</option><option value="LV">Latvia</option><option value="LT">Lithuania</option><option value="LU">Luxembourg</option><option value="MY">Malaysia</option><option value="MT">Malta</option><option value="MX">Mexico</option><option value="NL">Netherlands</option><option value="NZ">New Zealand</option><option value="NO">Norway</option><option value="PH">Philippines</option><option value="PL">Poland</option><option value="PT">Portugal</option><option value="PR">Puerto Rico</option><option value="RO">Romania</option><option value="RU">Russia</option><option value="SG">Singapore</option><option value="SK">Slovakia</option><option value="SI">Slovenia</option><option value="ZA">South Africa</option><option value="KR">South Korea</option><option value="ES">Spain</option><option value="VC">St. Vincent</option><option value="SE">Sweden</option><option value="CH">Switzerland</option><option value="SY">Syria</option><option value="TW">Taiwan</option><option value="TH">Thailand</option><option value="TT">Trinidad and Tobago</option><option value="TR">Turkey</option><option value="US" selected="selected">USA</option><option value="AE">United Arab Emirates</option><option value="GB">United Kingdom</option><option value="UY">Uruguay</option><option value="VE">Venezuela</option>-->
<!--                                            </select>-->
<!--                                        </div>-->
<!--                                    </div>-->
<!--                                    <div class="cfw-column-4">-->
<!--                                        <div class="cfw-input-wrap cfw-text-input">-->
<!--                                            <label class="cfw-input-label" for="cfw-billing-zip-code">Zip Code</label>-->
<!--                                            <input type="text" id="cfw-billing-zip-code" name="cfw-billing-zip-code" autocomplete="billing zip-code" title="Zip Code" placeholder="Zip Code" class="required" />-->
<!--                                        </div>-->
<!--                                    </div>-->
<!--                                    <div class="cfw-column-4">-->
<!--                                        <div class="cfw-input-wrap cfw-select-input">-->
<!--                                            <label class="cfw-input-label" for="cfw-billing-state">State</label>-->
<!--                                            <select title="Billing State" id="cfw-billing-state" name="cfw-billing-state" autocomplete="billing state" class="garlic-auto-save">-->
