                            ...
                            <div id="order_review" class="woocommerce-checkout-review-order">
                                ...
                                <div id="cfw-customer-info" class="cfw-panel">
                                    ...
                                    <div id="cfw-shipping-info" class="cfw-module">
		                                <?php do_action( sprintf( 'cfw_checkout_before_%s_address', WC()->cart->needs_shipping_address() ? 'shipping' : 'billing' ) ); ?>
		                                ...
		                                <?php do_action( sprintf( 'cfw_checkout_after_%s_address', WC()->cart->needs_shipping_address() ? 'shipping' : 'billing' ) ); ?>
                                    </div>
                            ...
                            <div id="cfw-cart-details-review-bar" class="cfw-sg-container">
                                <div class="cfw-column-8">
                                    <a id="cfw-show-cart-details">
                                        <span class="cfw-link"><?php echo apply_filters( 'cfw_show_order_summary_link_text', esc_html( 'Show order summary', 'checkout-wc' ) ); ?></span>
