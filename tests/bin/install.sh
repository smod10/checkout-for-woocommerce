...
# Also See https://raw.githubusercontent.com/woocommerce/woocommerce/master/tests/bin/install.sh
...
PHP
        ...
        sed $ioption "s/cypresspathplzoverride/$CFW_DIR/" "$CYPRESS_FILES_FOLDER"/cypress.env.json
